#include <stdio.h>
#include <cs50.h>
#include <stdlib.h> // Convert types --> atoi
#include <string.h> // getting the length of a string
#include <ctype.h> // For checking of islower, isupper, and isalpha
...
int main(int argc, string argv[])
{
    ...
    // get a plaintext from the user for encryption
...
// Formula: c = (p - A + k) % 26 + A --> where A is the ASCII number
